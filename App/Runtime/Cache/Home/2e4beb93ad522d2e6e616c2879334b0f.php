...
<script type="text/javascript" src="/xyhcms_v3.5/xyhcms_v3.5_20180518/uploads_code/Data/static/js/jquery-1.12.4.min.js" ></script>
<link rel="stylesheet" href="/xyhcms_v3.5/xyhcms_v3.5_20180518/uploads_code/Public/Home/default/js/FlexSlider/flexslider.css" type="text/css" />
<link href="/xyhcms_v3.5/xyhcms_v3.5_20180518/uploads_code/Public/Home/default/css/css.css?2017" rel="stylesheet" type="text/css" />
<script language="javascript" type="text/javascript" src="/xyhcms_v3.5/xyhcms_v3.5_20180518/uploads_code/Public/Home/default/js/FlexSlider/jquery.flexslider-min.js"></script>
...
<?php
 $_flag = 0; switch ($_flag) { case 0: if (C('CFG_MOBILE_AUTO') == 1) { if (C('HTML_CACHE_ON') == true) { echo '<script type="text/javascript" src="/xyhcms_v3.5/xyhcms_v3.5_20180518/uploads_code/Data/static/js/mobile_auto.js"></script>'; } else { go_mobile(); } } break; case 1: go_mobile(); break; case 2: if (C('CFG_MOBILE_AUTO') == 1) { echo '<script type="text/javascript" src="/xyhcms_v3.5/xyhcms_v3.5_20180518/uploads_code/Data/static/js/mobile_auto.js"></script>'; } break; default: break; } ?>
</head>
<body>
...
<div class="warp" id="herd">
	...
	<div id="top_logo"><a href="http://localhost/xyhcms_v3.5/xyhcms_v3.5_20180518/uploads_code"></a></div>
</div>
<!--menu -->
<div id="menu">
	<ul>
		<li><a href="http://localhost/xyhcms_v3.5/xyhcms_v3.5_20180518/uploads_code">首 页</a></li>
		<?php
...
<div class="left f_l">
 ...
 $block = get_block('Introduction'); $block_content = ''; if ($block) { if ($block['block_type'] == 2) { if (!0) { $block_content = '<img src="'. $block['content'] .'" />'; }else { $block_content = $block['content']; } }else { if(0) { $block_content = str2sub(strip_tags($block['content']), 0, 0); }else { $block_content = $block['content']; } } } echo $block_content; ?>
	...
	<div class="mt">
		...
		<form id="SearchForm" name="SearchForm" method="post" action="/xyhcms_v3.5/xyhcms_v3.5_20180518/uploads_code/index.php?s=/Search/index.html		
		">
...
<script language="javascript" src="/xyhcms_v3.5/xyhcms_v3.5_20180518/uploads_code/Public/Home/default/js/MSClass.js"></script>
<script type="text/javascript">
...
<div class="warp1 mt" id="bottom">
	<a href="http://localhost/xyhcms_v3.5/xyhcms_v3.5_20180518/uploads_code">我的网站</a>版权所有
	<br />
